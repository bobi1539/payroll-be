...
const ALLOWANCE_TYPE_NOT_FOUND = "allowance type not found | jenis tunjangan tidak ditemukan"
const ALLOWANCE_NOT_FOUND = "allowance not found | tunjangan tidak ditemukan"
